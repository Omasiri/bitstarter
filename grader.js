...
//var URLFILE_DEFAULT="http://rocky-garden-5417.herokuapp.com/";
//var restler = require('rester');
...
var getUrl = function(url,response){
...
if(require.main == module) {
	...
	.option('-u, --url <url_file>', 'Url to html', clone(assertUrlValid))
        .parse(process.argv);
